...
SECRET_KEY = 'django-insecure-y#kq9#yanejtlt!dh_d)n%olp529pk)%uq)-m)zri6z=-n$4@!'
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv('POSTGRES_PASSWORD', '142857'),
...
CSRF_COOKIE_SAMESITE = "Lax" #Debe ser None en producción
